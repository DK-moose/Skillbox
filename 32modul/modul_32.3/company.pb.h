...
class Company final :
 ...
 public:
  ...
  // optional bool feActivity = 5;
  bool has_feactivity() const;
  private:
  bool _internal_has_feactivity() const;
  public:
  void clear_feactivity();
  bool feactivity() const;
  void set_feactivity(bool value);
  private:
  bool _internal_feactivity() const;
  void _internal_set_feactivity(bool value);
  public:
...
// optional bool feActivity = 5;
inline bool Company::_internal_has_feactivity() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Company::has_feactivity() const {
  return _internal_has_feactivity();
}
inline void Company::clear_feactivity() {
  _impl_.feactivity_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Company::_internal_feactivity() const {
  return _impl_.feactivity_;
}
inline bool Company::feactivity() const {
  // @@protoc_insertion_point(field_get:Company.feActivity)
  return _internal_feactivity();
}
inline void Company::_internal_set_feactivity(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.feactivity_ = value;
}
inline void Company::set_feactivity(bool value) {
  _internal_set_feactivity(value);
  // @@protoc_insertion_point(field_set:Company.feActivity)
}
