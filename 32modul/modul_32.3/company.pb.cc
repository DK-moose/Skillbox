...
PROTOBUF_CONSTEXPR Company::Company(
  ...
  , /*decltype(_impl_.feactivity_)*/false} {}
...
const uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, _impl_.typeactivity_),
  PROTOBUF_FIELD_OFFSET(::Company, _impl_.feactivity_),
  3,
  0,
  1,
  2,
...
class Company::_Internal {
 public:
  ...
  static void set_has_feactivity(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  ::memcpy(&_impl_.year_, &from._impl_.year_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.feactivity_) -
    reinterpret_cast<char*>(&_impl_.year_)) + sizeof(_impl_.feactivity_));
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.feactivity_) -
        reinterpret_cast<char*>(&_impl_.year_)) + sizeof(_impl_.feactivity_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_feactivity(&has_bits);
          _impl_.feactivity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_feactivity(), target);
  }
...
void Company::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.feactivity_ = from._impl_.feactivity_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, _impl_.feactivity_)
      + sizeof(Company::_impl_.feactivity_)
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.year_)>(
